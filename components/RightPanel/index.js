  ...
  return (
    <div className="w-full flex flex-col items-start space-y-8">
      ...
      <div className="space-y-2">
        ...
        >
          Generate your <span className="text-[#FF2E63]"><TypeWriter words={typingWords} /></span>. Instantly.
        </motion.div>
      </div>
        ...
        {workflowSteps.map((step, idx) => (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-[#FF2E63] flex items-center 
                            justify-center text-white font-medium text-sm shrink-0">
                {step.number}
              </div>
              <div>
